...
namespace CommandBar.DemoApp
{
    public class MainViewModel
    {
        ...
        public ToolbarModel FormattingToolbar { get; }

        public MainViewModel()
        {
            MainToolbar = Manager.CreateToolbar("Standard Toolbar");
            FormattingToolbar = Manager.CreateToolbar("Formatting Toolbar");
            ...
            var btnItalic = new CommandToggleItem
            {
                Text = "Italic",
            ...
            Manager.RegisterCommand(btnNew);
            Manager.RegisterCommand(btnBold);
            Manager.RegisterCommand(separator);
            Manager.RegisterCommand(btnItalic);

            MainToolbar.DockedItems.Add(btnSave);
            MainToolbar.DockedItems.Add(separator);
            MainToolbar.DockedItems.Add(btnNew);
            FormattingToolbar.DockedItems.Add(btnBold);
            FormattingToolbar.DockedItems.Add(btnItalic);
